...
def parse_option():
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Path to data file, e.g ./train_w_options_new.json",
    )
    parser.add_argument(
        "--fewshot_size",
        type=int,
        choices=[50, 20, 10, 5, 1],
        default=10,
        help="50, 20 or 10 percent of full dataset",
    )
...
with open(
    os.path.join(
        os.path.dirname(args.path), fewshot_file + str(args.fewshot_size) + ".json"
    ),
    "w",
) as f:
