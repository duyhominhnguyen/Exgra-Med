...
def eval_model(args, question_file, answers_base_path):
    ...
    for i, line in enumerate(tqdm(questions)):
        try:
            question, gt_ans, image = preprocess_input(args.image_folder, line)
...
def preprocess_input(image_folder, entity) -> tuple:
    ...
    image = read_img_from_url(os.path.join(image_folder,image_url))
